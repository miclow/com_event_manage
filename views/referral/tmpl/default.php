...
<div class="page1 span12">
	<div class="form-title"> <h3>Referral Page</h3> </div>
	<div class="form-body left span10">			
		<form action="" method="post" enctype="multipart/form-data" id="page6b" class="form-validate">
			...
			<div class="control-group">
				...
				<table cellpadding="10" cellspacing="5">
					...
					if($value == 'harmlessorindemnity'){ ?>
						<tr>
							<td><?php echo $n;?></td>
							<td>Will you be signing any contracts that contain hold harmless or indemnity agreements?</td>
							<td>You have answered YES</td>
							<td>
								<div class="">
									<a href="<?php echo $pag3url; ?>" value="Modify" class="btn btn-primary" >Modify</a>
						...
						if($value == 'subcontractors'){ ?>
						<tr>
							<td><?php echo $n;?></td>
							<td>Do you use subcontractors?</td>
							<td>You have answered YES</td>
							<td>
								<div class="">
									<a href="<?php echo $pag3url; ?>" value="Modify" class="btn btn-primary" >Modify</a>
		...
		<div class="control-group pull-left MyMargin">
			<div class="controls">
				...
				<input type="button" class="btn btn-primary" id="SaveComeBackRefreal" name="Savedata" value="Save & Exit">
				<?php } else { ?>
				...
				<div id="expert-msg" style="display:none; padding:10px; font-size:15px;">
					<strong>Thank you. A staff member will be in touch.</strong>
				</div>
			</div>
		</div>
