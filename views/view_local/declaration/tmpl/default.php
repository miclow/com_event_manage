...
<div class="page1">
	...
	<div class="form-title"> <h1>Declaration Page 5</h1> </div>
		...
		<form action="" method="post" enctype="multipart/form-data" id="page5" class="form-validate">
			...
			<div class="control-group">
				<div class="control-label">
					When you order you accept our <a href="#">Terms and Conditions</a> 
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group">
				<div class="control-label">
					...
					<a href="#">Binder Advice Warning</a>, <a href="#">Policy Wording</a>, <a href="#">Financial Services Guide</a>, <a href="#">Duty of Disclosure</a>, <a href="#">Privacy Statement</a> & <a href="#">General Advice Warning</a>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('termconditions'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('termconditions'); ?></div>
			</div>
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('fsgread'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('fsgread'); ?></div>
			</div>
