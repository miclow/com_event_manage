...
<div class="page1">
	<div class="form-title"> <h1>User Details Page </h1></div>
	...
	<div class="tab-panel">
	    ...
	    <div class="content-area span12">
	        <div id="Reqiurment" class="active">
				...
				<div class="control-group span12">
					<div class="control-label span3">Name of Perfomers :</div>
					<div class="controls">
					<?php 
				...
				<div class="control-group span12">
					<div class="control-label span3">Estimed Annual Income :</div>
					<div class="controls">
					<?php 
				...
				<div class="control-group span12">
					<div class="control-label span3">Public Liaility Cover :</div>
					<div class="controls"><?php echo $data['page1']['liailitycover']; ?></div>
				</div>
	        </div>
	        ...
	        <div id="Quotation" class="inactive">
				...
				<div class="control-group span12">
					...
					<div class="controls"><?php echo $data['page2']['premium']; ?></div>
				</div>
				<div class="control-group span12">
					<div class="control-label span3">Administration Fee (Broker Fee) : </div>
					<div class="controls"><?php echo $data['page2']['brokerfee']; ?></div>
				</div>
				<div class="control-group span12">
					<div class="control-label span3">Sub Total :</div>
					<div class="controls"><?php echo $data['page2']['subtotal']; ?></div>
				</div>
				<div class="control-group span12">
					<div class="control-label span3"> GST Premium :</div>
					<div class="controls"><?php echo $data['page2']['gstpremium']; ?></div>
				</div>
				<div class="control-group span12">
					<div class="control-label span3">Stamp Duty :</div>
					<div class="controls"><?php echo $data['page2']['stampduty']; ?></div>
				</div>
				<div class="control-group span12">
					<div class="control-label span3">Administration Fee GST :</div>
					<div class="controls"><?php echo $data['page2']['gstfee']; ?></div>
				</div>
				<div class="control-group span12">
					<div class="control-label span3">Total Premium (includes Commission) :</div>
					<div class="controls"><?php echo $data['page2']['totalpremium']; ?></div>
				</div>
				<div class="control-group span12">
					<div class="control-label span3">Commission :</div>
					<div class="controls"><?php echo $data['page2']['commission']; ?></div>
				</div>
				<div class="control-group span12">
					<div class="control-label span3">Commission GST :</div>
					<div class="controls"><?php echo $data['page2']['gstcommission']; ?></div>
				</div>
	        </div>
	        ...
	        <div id="Checkout" class="inactive">
				...
				<div class="control-group span12">
					...
					<div class="controls"><?php echo $data['page6']['publicliailitycover'];?></div>
				</div>
				<div class="control-group span12">
					<div class="control-label span3">Total Premium :</div>
					<div class="controls"><?php echo $data['page6']['totalpremium'];?></div>
				</div>
				<div class="control-group span12">
				...
				<div class="control-group span12">
					...
					<div class="controls"><?php echo $data['page6']['subtotal'];?></div>
				</div>
				<div class="control-group span12">
					<div class="control-label span3">Credit Card Fee :</div>
					<div class="controls"><?php echo $data['page6']['creditcardfee'];?></div>
				</div>
				<div class="control-group span12">
					<div class="control-label span3">Order Total : </div>
					<div class="controls"><?php echo $data['page6']['orderTotal'];?></div>
				</div>
				<div class="control-group span12">
