...
<div class="page1">
	...
	<div class="form-title"> <h1>Address Page 4</h1> </div>
		...
		<form action="" method="post" enctype="multipart/form-data" id="page4" class="form-validate">
			...
			<div class="row-fluid top15">
				<div class="span12" style="margin-left:0";>	
					...
					<div class="control-group span4">
						...
						<div class="control-label"><?php echo $this->form->getLabel('insuredname'); ?></div>

						<div class="controls"><input type="text" id="jform_insuredname" name="jform[insuredname]" value="<?php echo $this->progress->data['page1']['insurencename'];?>" aria-invalid="false"></div>
			...
			<div class="row-fluid top15">
				<div class="span12" style="margin-left:0";>	
					...
					<div class="control-group span4">
						...
						<div class="control-label"><?php echo $this->form->getLabel('streetaddress1'); ?></div>

						<div class="controls"><?php echo $this->form->getInput('streetaddress1'); ?></div>

					</div>

					<div class="control-group span4">

						<div class="control-label"><?php echo $this->form->getLabel('streetaddress2'); ?></div>

						<div class="controls"><?php echo $this->form->getInput('streetaddress2'); ?></div>
			...
			<div class="row-fluid top15">
				<div class="span12" style="margin-left:0";>	
					...
					<div class="control-group span4">
						...
						<div class="controls">
							<input type="text" value="<?php echo $this->progress->data['page1']['postcode']; ?>" id="jform_postcode" name="jform[postcode]" aria-invalid="false">
						</div>
			...
			<div class="row-fluid top15">
				<div class="span12" style="margin-left:0";>	
					...
					<div class="control-group span4">
						...
						<input type="checkbox" id="jform_sameaddress0" name="jform[sameaddress][]" value="Y"> Yes
					</div>

					<div class="control-group span4">

						<div class="control-label"><?php echo $this->form->getLabel('billingaddress1'); ?></div>

						<div class="controls"><?php echo $this->form->getInput('billingaddress1'); ?></div>

					</div>

					<div class="control-group span4">

						<div class="control-label"><?php echo $this->form->getLabel('billingaddress2'); ?></div>

						<div class="controls"><?php echo $this->form->getInput('billingaddress2'); ?></div>
			...
			<div class="row-fluid top15">
				<div class="span12" style="margin-left:0";>	
					...
					<div class="control-group span4">
						...
						<div class="control-label"><?php echo $this->form->getLabel('billingsuburb'); ?></div>

						<div class="controls"><?php echo $this->form->getInput('billingsuburb'); ?></div>

					</div>

					<div class="control-group span4">

						<div class="control-label"><?php echo $this->form->getLabel('billingstate'); ?></div>

						<div class="controls"><?php echo $this->form->getInput('billingstate'); ?></div>

					</div>

					<div class="control-group span4">

						<div class="control-label"><?php echo $this->form->getLabel('billingpostcode'); ?></div>

						<div class="controls">
							<?php //echo $this->form->getInput('billingpostcode'); ?>
							<input type="text" value="<?php echo $this->progress->data['page1']['postcode'];?>" id="jform_billingpostcode" name="jform[billingpostcode]" aria-invalid="false">
						</div>
			...
			<div class="control-group pull-left MyMargin">
				...
				<div class="controls ">
					...
					<input type="button" class="btn btn-primary" name="Savedata" id="SaveComeBack" value="Save & Come back Later">
				</div>
