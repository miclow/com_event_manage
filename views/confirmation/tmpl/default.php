...
<div class="page1">
	...
	<div class="form-title"> <h3>Page 7: Confirmation</h3> </div>
	<div class="form-body left span9">			
		<form action="" method="post" enctype="multipart/form-data" id="page7" class="form-validate">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php if(!empty($this->frontdata->policy_number)) { echo $this->frontdata->policy_number; }else { echo '&nbsp;' ;} ?>
				</div>
			</div>	
			<div class="control-group">
				<div class="control-label span3">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo  '$'.number_format($TotalPremium,2); ?>			
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
					Should you have any questions please contact us at: <br>
					Email: <a href="mailto:entertainment@actioninsurance.com.au">entertainment@actioninsurance.com.au</a><br>
